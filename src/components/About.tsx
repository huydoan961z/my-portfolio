      ...
      <div className="w-full max-w-6xl px-8 sm:px-12 lg:px-16">
        ...
        >
          ...
          <div className="space-y-4 text-secondary leading-relaxed">
            <p>
              I'm a passionate <span className={highlightClass}>Backend Developer</span>. Graduated from <span className="text-primary font-medium">FPT University</span>.
            </p>
            <p>
              With hands-on experience in <span className={highlightClass}>Spring Boot, Microservices Architecture, and Cloud Technologies</span>, I focus on building robust, scalable backend solutions and RESTful APIs.
            </p>
            <p>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          >
            ...
            <p className="text-secondary text-sm mt-2">Distinction Student (Sinh viên giỏi)</p>
          </motion.div>
